...
@Composable fun SettingsHome(ui: UiState, vm: AppViewModel, go: (String) -> Unit) {
    ...
    Column(Modifier.fillMaxSize().verticalScroll(rememberScrollState())) {
        ...
        SectionTitle("阅读体验", separated = true)
        ...
        SectionTitle("APP", separated = true)
        ...
        SectionTitle("网络与关于", separated = true)
    ...
    Column(Modifier.fillMaxSize().verticalScroll(rememberScrollState()).padding(bottom=28.dp)) {
        when(route) {
            "reading" -> {
                ...
                SectionTitle("翻页", separated = true)
                ...
                SectionTitle("显示与加载", separated = true)
                ...
                SectionTitle("缩放手势", separated = true)
            ...
            "appearance" -> {
                ...
                SectionTitle("显示", separated = true)
